...
class ConfigurationManager:
    ...
    #method for data transformation config
    ...
    #method for model training config
    ...
    #method for model evaluation config
    def get_model_evaluation_config(self)-> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            target_column = schema.name,
            mlflow_uri="https://dagshub.com/AdityaSanyal1996/MLflow.mlflow",
